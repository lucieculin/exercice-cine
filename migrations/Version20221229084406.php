 ...
 */
final class Version20221229084406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, composer_id INT NOT NULL, title VARCHAR(255) NOT NULL, retease_date DATE NOT NULL, synopsis LONGTEXT NOT NULL, INDEX IDX_1D5EF26F7A8D2620 (composer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
